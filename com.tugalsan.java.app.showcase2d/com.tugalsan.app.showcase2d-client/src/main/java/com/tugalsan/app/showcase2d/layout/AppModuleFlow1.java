...
public class AppModuleFlow1 extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleFlow1.class);
    ...
    public void run() {
        ...
        IntStream.range(0, 8).forEachOrdered(i -> {
            var b = AppTest_WidgetUtils.createButton("Button " + i);
