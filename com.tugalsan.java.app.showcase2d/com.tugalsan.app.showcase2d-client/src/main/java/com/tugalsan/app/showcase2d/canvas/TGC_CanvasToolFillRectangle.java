...
public class TGC_CanvasToolFillRectangle extends TGC_CanvasTool {

    final static TGC_Log d = TGC_Log.of(TGC_CanvasToolFillRectangle.class);

    protected TGC_CanvasToolFillRectangle(TGC_CanvasDriver driver) {
        super(driver);
    }
    ...
    private void paint(TGS_ShapeLocation<Integer> curLoc) {
        ...
        TGC_Canvas2DPaintFillUtils.paintRectRadius(driver.canvas, TGS_ShapeRectangle.of(toolStartLoc, dim), driver.getRadius());
    }
}
