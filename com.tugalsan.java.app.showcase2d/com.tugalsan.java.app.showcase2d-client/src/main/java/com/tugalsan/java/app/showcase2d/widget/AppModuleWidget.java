...
public class AppModuleWidget extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleWidget.class);
    ...
    @Override
    public void run() {
        var L0 = AppTest_WidgetUtils.createHTML("This HTML is added to Root Panel.");
        var L1 = AppTest_WidgetUtils.createHTML("This HTML is added to Root Panel.");
