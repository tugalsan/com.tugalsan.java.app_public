...
public class AppModuleUpload extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleUpload.class);
    ...
    @Override
    public void run() {
        var p = AppTest_PanelFileUploadUtils.create("Bir dosya seçiniz:", "Yükle", r -> d.ce("upload", r));
        widget = p;
    }
