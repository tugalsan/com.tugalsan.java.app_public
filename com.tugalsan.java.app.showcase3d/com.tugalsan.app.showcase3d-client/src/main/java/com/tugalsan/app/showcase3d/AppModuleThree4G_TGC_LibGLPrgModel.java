...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgModel;

public class AppModuleThree4G_TGC_LibGLPrgModel extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgModel.class);
