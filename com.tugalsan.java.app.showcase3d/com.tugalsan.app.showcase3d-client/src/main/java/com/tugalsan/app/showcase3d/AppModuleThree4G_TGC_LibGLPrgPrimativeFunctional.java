...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgPrimativeFunctional;

public class AppModuleThree4G_TGC_LibGLPrgPrimativeFunctional extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgPrimativeFunctional.class);
    ...
    public void initControllers(TGS_FuncMTU exe) {
        ...
        gl = new TGC_LibGLPrgPrimativeFunctional();
        exe.run();
    }
