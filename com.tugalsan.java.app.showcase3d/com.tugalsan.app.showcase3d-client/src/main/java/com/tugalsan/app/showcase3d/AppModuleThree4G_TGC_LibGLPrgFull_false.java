...
public class AppModuleThree4G_TGC_LibGLPrgFull_false extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgFull_false.class);
