...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgSprite;

public class AppModuleThree4G_TGC_LibGLPrgSprite extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgSprite.class);
