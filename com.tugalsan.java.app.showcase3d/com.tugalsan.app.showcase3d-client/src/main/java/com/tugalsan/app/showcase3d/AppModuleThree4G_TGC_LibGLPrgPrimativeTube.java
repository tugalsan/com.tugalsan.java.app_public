...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgPrimativeTube;

public class AppModuleThree4G_TGC_LibGLPrgPrimativeTube extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgPrimativeTube.class);
    ...
    public void initControllers(TGS_FuncMTU exe) {
        ...
        gl = new TGC_LibGLPrgPrimativeTube();
        exe.run();
    }
