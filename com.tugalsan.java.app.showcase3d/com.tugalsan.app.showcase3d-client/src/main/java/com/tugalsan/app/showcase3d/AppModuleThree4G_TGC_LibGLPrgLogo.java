...
import com.tugalsan.java.api.gui.gl.client.three4g.TGC_GLProgramAbstract;
import com.tugalsan.java.api.gui.client.browser.TGC_BrowserWindowUtils;

import com.tugalsan.java.api.file.html.client.*;
import com.tugalsan.java.api.gui.client.dim.TGC_DimensionUtils;
import com.tugalsan.java.api.shape.client.TGS_ShapeMargin;
import com.tugalsan.java.lib.boot.client.*;
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgLogo;
import com.tugalsan.java.lib.gl.client.res.TGC_LibGLResFontUtils;

public class AppModuleThree4G_TGC_LibGLPrgLogo extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgLogo.class);
    ...
    public void initControllers(TGS_FuncMTU exe) {
        ...
        gl = new TGC_LibGLPrgLogo();
        TGC_LibGLResFontUtils.addDefault(gl.fonts);
        gl.setText(d.className());
        exe.run();
    }
    private TGC_LibGLPrgLogo gl;
