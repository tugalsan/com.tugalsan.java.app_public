...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgPrimativeCommon;

public class AppModuleThree4G_TGC_LibGLPrgPrimativeCommon extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgPrimativeCommon.class);
    ...
    public void initControllers(TGS_FuncMTU exe) {
        ...
        gl = new TGC_LibGLPrgPrimativeCommon();
        exe.run();
    }
