...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgPrimativeShape;

public class AppModuleThree4G_TGC_LibGLPrgPrimativeShape extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgPrimativeShape.class);
    ...
    public void initControllers(TGS_FuncMTU exe) {
        ...
        gl = new TGC_LibGLPrgPrimativeShape();
        exe.run();
    }
