...
import com.tugalsan.java.lib.gl.client.prg.TGC_LibGLPrgPrimativeText;

public class AppModuleThree4G_TGC_LibGLPrgPrimativeText extends TGC_LibBootModulePanel {

    final private static TGC_Log d = TGC_Log.of(AppModuleThree4G_TGC_LibGLPrgPrimativeText.class);
    ...
    public void initControllers(TGS_FuncMTU exe) {
        ...
        gl = new TGC_LibGLPrgPrimativeText();
        exe.run();
    }
